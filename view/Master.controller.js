jQuery.sap.require("com.nnit.demo.scanner.util.Formatter");
jQuery.sap.require("com.nnit.demo.scanner.util.Controller");

com.nnit.demo.scanner.util.Controller.extend("com.nnit.demo.scanner.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.nnit.demo.scanner.view.Detail",
			targetViewType: "XML"
		});
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("Barcode", sap.ui.model.FilterOperator.Contains, searchString)];
		}
