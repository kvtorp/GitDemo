...
com.nnit.demo.scanner.util.Controller.extend("com.nnit.demo.scanner.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.nnit.demo.scanner.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.nnit.demo.scanner.view.NotFound",
			targetViewType: "XML"
		});
	},
