jQuery.sap.declare("com.nnit.demo.scanner.Component");
jQuery.sap.require("com.nnit.demo.scanner.MyRouter");

sap.ui.core.UIComponent.extend("com.nnit.demo.scanner.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.nnit.demo.scanner.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "ZSCANNER_SRV",
				serviceUrl: "/sap/opu/odata/IWFND/CATALOGSERVICE/sap/ZSCANNER_SRV/"
			}
		},

		routing: {
			config: {
				routerClass: com.nnit.demo.scanner.MyRouter,
				viewType: "XML",
				viewPath: "com.nnit.demo.scanner.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.nnit.demo.scanner");
		...
		var oModel;
		var externalURL = com.nnit.demo.scanner.dev.devapp.externalURL;
		var appContext;
		if (com.nnit.demo.scanner.dev.devapp.devLogon) {
			appContext = com.nnit.demo.scanner.dev.devapp.devLogon.appContext;
		}
